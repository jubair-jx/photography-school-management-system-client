  ...
  return (
    <div>
        ...
        {data?.map((item) => (
          ...
          >
            <div className="ml-[18px] flex h-[90px] w-auto flex-row items-center">
              <div className="rounded-full bg-lightPrimary p-3 bg-violet-100">
                <span className="flex items-center text-brand-500 text-violet-600">
                  {item?.icon}
                </span>
              </div>
            </div>
      ...
      <div className=" font-poppins w-full sm:w-[98%] bg-white shadow-md border rounded border-dashed mx-auto">
        <CourseOverview titleText="My Course Selling Overview" />
      </div>
    </div>
  );
};
